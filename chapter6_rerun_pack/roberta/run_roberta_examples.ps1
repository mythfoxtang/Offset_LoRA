...
python .\chapter6_rerun_pack\exp_roberta_sst2_manual.py --mode offset --lr 1e-3 --seed 1 --max-steps 80
python .\chapter6_rerun_pack\exp_roberta_sst2_manual.py --mode standard --lr 1e-3 --seed 1 --max-steps 80
